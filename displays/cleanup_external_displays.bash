...
# Optionally restart WindowServer
echo
read -p "Do you want to restart WindowServer now to refresh displays? (This will log you out) [y/N]: " RESP
if [[ "$RESP" =~ ^[Yy]$ ]]; then
...
echo
echo "Done. External monitors should reset automatically on next login."
